  ...
  return (
    ...
    >
      <div
        className={
          modalIsOpen
            ? "relative flex flex-col gap-4 py-4 w-[70%] min-h-[50%] h-auto pb-4 md:h-[70%] bg-gray-two text-white translate-y-0 duration-500"
            : "relative flex flex-col gap-4 py-4 w-[70%] min-h-[50%] h-auto pb-4 md:h-[70%] bg-gray-two text-white -translate-y-full duration-500"
        }
      >
        ...
        <span className=" text-center mt-4">
          ...
          >
            {lenguage === "english" ? "Access Website" : "Acessar o site"}
          </Link>
        </span>
        <button
          className="absolute top-2 right-2 mb-4"
